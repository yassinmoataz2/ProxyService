...
- Get the handler script from [here](https://github.com/yassinmoataz2/ProxyService/blob/master/client/ProxyService.mod.lua) and put it in a module script in ServerScriptService.
